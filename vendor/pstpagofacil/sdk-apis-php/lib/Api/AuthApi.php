...
class AuthApi
{
    ...
    {
        list($response) = $this->usersLoginPostWithHttpInfo($login_body);
        return $response;
    }
     ...
     */
    public function usersLoginPostAsync($login_body = null)
    {
        return $this->usersLoginPostAsyncWithHttpInfo($login_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function usersLoginPostRequest($login_body = null)
    {
