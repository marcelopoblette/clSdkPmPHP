...
class RemittancesApi
{
    ...
    /**
     * Operation remittancesConciliationGet
     *
    ...
    {
        list($response) = $this->remittancesConciliationGetWithHttpInfo($email, $date);
        return $response;
    }

    /**
     * Operation remittancesConciliationGetWithHttpInfo
     *
     * @param  string $email Email a consultar (required)
     * @param  \DateTime $date Fecha de consulta año-mes-dia &lt;br&gt; Ej: 2019-12-31 (required)
     *
    ...
    /**
     * Operation remittancesConciliationGetAsync
     *
     * 
     *
     * @param  string $email Email a consultar (required)
     ...
     */
    public function remittancesConciliationGetAsync($email, $date)
    {
        return $this->remittancesConciliationGetAsyncWithHttpInfo($email, $date)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation remittancesConciliationGetAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $email Email a consultar (required)
    ...
    /**
     * Create request for operation 'remittancesConciliationGet'
     *
     * @param  string $email Email a consultar (required)
     * @param  \DateTime $date Fecha de consulta año-mes-dia &lt;br&gt; Ej: 2019-12-31 (required)
     *
     ...
     */
    protected function remittancesConciliationGetRequest($email, $date)
    {
        // verify the required parameter 'email' is set
        if ($email === null || (is_array($email) && count($email) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email when calling remittancesConciliationGet'
            );
        }
        if (!preg_match("/^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$/", $email)) {
            throw new \InvalidArgumentException("invalid value for \"email\" when calling RemittancesApi.remittancesConciliationGet, must conform to the pattern /^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$/.");
        }

        // verify the required parameter 'date' is set
        if ($date === null || (is_array($date) && count($date) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $date when calling remittancesConciliationGet'
            );
        }

        $resourcePath = '/remittances/conciliation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
